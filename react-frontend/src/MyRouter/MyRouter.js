...
import SingleJobOpeningPage from "../components/app_components/JobOpeningPage/SingleJobOpeningPage";
import JobOpeningProjectLayoutPage from "../components/app_components/JobOpeningPage/JobOpeningProjectLayoutPage";
import SingleApplicationPage from "../components/app_components/ApplicationPage/SingleApplicationPage";
import ApplicationProjectLayoutPage from "../components/app_components/ApplicationPage/ApplicationProjectLayoutPage";
import SingleEmployeePage from "../components/app_components/EmployeePage/SingleEmployeePage";
import EmployeeProjectLayoutPage from "../components/app_components/EmployeePage/EmployeeProjectLayoutPage";
import SingleCandidatePage from "../components/app_components/CandidatePage/SingleCandidatePage";
import CandidateProjectLayoutPage from "../components/app_components/CandidatePage/CandidateProjectLayoutPage";
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/jobOpening/:singleJobOpeningId" exact element={<SingleJobOpeningPage />} />
<Route path="/jobOpening" exact element={<JobOpeningProjectLayoutPage />} />
<Route path="/application/:singleApplicationId" exact element={<SingleApplicationPage />} />
<Route path="/application" exact element={<ApplicationProjectLayoutPage />} />
...
<Route path="/candidate/:singleCandidateId" exact element={<SingleCandidatePage />} />
<Route path="/candidate" exact element={<CandidateProjectLayoutPage />} />
