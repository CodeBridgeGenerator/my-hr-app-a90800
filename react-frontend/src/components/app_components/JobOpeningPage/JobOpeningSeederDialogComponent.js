...
import seederData from "./jobOpening.seeder.json";
...
const JobOpeningSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(JobOpeningSeederDialogComponent);
