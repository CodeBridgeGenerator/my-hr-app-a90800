...
const CandidateDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const progressBarTemplate3 = (rowData, { rowIndex }) => <ProgressBar value={rowData.matchPercentage} style={{width:"20rem"}}  />
...
<Column field="matchPercentage" header="MatchPercentage" body={progressBarTemplate3} filter={selectedFilterFields.includes("matchPercentage")} hidden={selectedHideFields?.includes("matchPercentage")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Candidate Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Candidate" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
