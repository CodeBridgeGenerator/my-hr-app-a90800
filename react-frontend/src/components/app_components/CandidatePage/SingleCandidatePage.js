...
const SingleCandidatePage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("candidate")
            .get(urlParams.singleCandidateId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCandidateId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>candidate/{urlParams.singleCandidateId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">MatchPercentage</label><p className="m-0 ml-3" ><ProgressBar id="matchPercentage" value={Number(_entity?.matchPercentage)}/></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleCandidateId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleCandidatePage);
