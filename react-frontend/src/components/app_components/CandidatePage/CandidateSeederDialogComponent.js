...
import seederData from "./candidate.seeder.json";
...
const CandidateSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CandidateSeederDialogComponent);
