...
import seederData from "./application.seeder.json";
...
const ApplicationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ApplicationSeederDialogComponent);
