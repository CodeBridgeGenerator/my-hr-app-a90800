...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">SubmittedAt</label><p className="m-0 ml-3" ><Calendar id="submittedAt" value={new Date(_entity?.submittedAt)} disabled={true} hourFormat="12"   /></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleApplicationId}
        user={props.user}
        alert={props.alert}
